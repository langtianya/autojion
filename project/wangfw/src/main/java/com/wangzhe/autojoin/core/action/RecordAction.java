...
public class RecordAction extends ActionSupport {
    ...
    public String recordList() {
        ...
        try {
            ...
            int maxRowCount = 0;    //一共有多少行
            int rowsPerPage = 30; //每页有多少行
            int maxPage; //一共有多少页
            try {
...
//            System.out.println("aa" + records.size());
            ...
            if (records != null && records.size() == 0) {
                request.setAttribute("msg", "沒有搜索到您查询的相关结果！");
            }
    ...
    public String recharge() {
        ...
        try {
            ...
            if (aId != null) {
                ...
                request.setAttribute("msg", "提交信息不合法,客户信息错误!");
                return "error";
            }
            ...
            if (rClick == null || !StringUtils.isNumeric(rClick)) {
                request.setAttribute("msg", "提交信息不合法,点数错误!");
                return "error";
            }
            ...
            if (rMoney == null || !StringUtils.isNumeric(rMoney)) {
                request.setAttribute("msg", "提交信息不合法,钱数错误!");
                return "error";
            }
            Integer money = 0;
            Integer click = 0;
            ...
            if (uid == null || !StringUtils.isNumeric(uid)) {
                request.setAttribute("msg", "提交信息不合法,操作人错误!");
                return "error";
            }
    ...
    public String deleteRecord() {
        ...
        if (rid == null || !StringUtils.isNumeric(rid)) {
            request.setAttribute("msg", "数据不合法!");
            return "error";
        }
        ...
        if (user == null || user.getUAuth() == null || user.getUAuth() != 1) {
            ...
            request.setAttribute("msg", "您无权限删除订单记录!");
            return "error";
        }
    ...
    public String edit() {
        ...
        if (user == null || user.getUAuth() == null || user.getUAuth() != 1) {
            ...
            request.setAttribute("msg", "您无权限修改订单记录!");
            return "error";
        }
