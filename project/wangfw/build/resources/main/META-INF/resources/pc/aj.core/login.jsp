...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <element>
    <body>
        <div id="login_title">后台系统</div>
        <div id="login_form" >
            <div id="login_form_box">
                <form id="loginForm" action="${pageContext.request.contextPath}/loginCheck" method="POST">
                    ...
                    <div class="textbox"><input name="user" type="text" placeholder="帐号"/></div>

                    <div class="textbox"><input name="pwd" type="password" placeholder="密码"/></div>
